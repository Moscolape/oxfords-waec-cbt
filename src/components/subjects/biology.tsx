...
const Biology = () => {
  ...
  const [hasSubmitted, setHasSubmitted] = useState(() =>
    JSON.parse(localStorage.getItem("biologyHasSubmitted") || "false")
  );
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setSubmitting(true);
    localStorage.setItem("biologyHasSubmitted", "true");
    ...
    try {
      ...
      localStorage.removeItem("biologyHasSubmitted");
      localStorage.removeItem("biologyQuizStartTime");
    } catch (error) {
      console.error("Submission error:", error);
      setHasSubmitted(false);
      localStorage.setItem("biologyHasSubmitted", "false");
  ...
  useEffect(() => {
    const storedStartTime = localStorage.getItem("biologyQuizStartTime");
    ...
    if (storedStartTime) {
      ...
      startTime = Date.now();
      localStorage.setItem("biologyQuizStartTime", startTime.toString());
    }
    ...
    <DashboardWrapper>
      <div className="w-full max-w-6xl mx-auto font-Inter p-5 pt-25">
        <div className="flex justify-between items-center mb-5">
          <h1 className="text-2xl font-bold">Biology Test</h1>
